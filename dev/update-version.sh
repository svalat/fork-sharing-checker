...
######################################################
#mv gentoo ebuild
git mv packaging/gentoo/dev-util/fork-sharing-checker/fork-sharing-checker-${OLD_VERSION}.ebuild packaging/gentoo/dev-util/fork-sharing-checker/fork-sharing-checker-${version}.ebuild
...
grep -RHn "$(echo "${OLD_VERSION}" | sed -e 's/\./\\./g')" ./ | grep -v node_modules | grep -v extern-deps | grep -v "\.git" | grep -v ChangeLog.md | grep "${OLD_VERSION}"
echo "================================================================="
