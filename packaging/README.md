...
First create a directory in your home dir, place the project archive in it and rename it to _0.1.0.orig.tar.gz.
...
If you work with git version you can build the archive with :
	...
	git archive --prefix=-0.1.0/ 0.1.0 | gzip > _0.1.0.orig.tar.gz

Go to your directory and extract _0.1.0.orig.tar.gz with and go in the directory.

	tar -xvzf -0.1.0.orig.tar.gz
	cd -0.1.0
...
Now generate the archive file (or download it from internet) :
	...
	git archive --prefix=-0.1.0/ 0.1.0 | bzip2 > ~/rpmbuild/SOURCES/-0.1.0.tar.bz2
...
--------------------------------------------------------------------
$user> git archive --prefix=fork-sharing-checker-0.1.0/ v0.1.0 | gzip > fork-sharing-checker-0.1.0.tar.gz
--------------------------------------------------------------------

Now got to the /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker and build the Manifest file :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild manifest
--------------------------------------------------------------------

Ok now you can test the build septs one by one :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild clean
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild fetch
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild unpack
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild prepare
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild configure
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild compile
#root> ebuild /usr/local/portage/myoverlay/dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0.ebuild test
--------------------------------------------------------------------
...
--------------------------------------------------------------------
#root> echo "=dev-utils/fork-sharing-checker/fork-sharing-checker-0.1.0" >> /etc/portage/package.keywords
